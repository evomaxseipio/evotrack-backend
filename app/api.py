...
from app.modules.organizations.departments_router import router as org_departments_router
...
# Register organization departments router (admin)
api_router.include_router(
    org_departments_router,
    prefix="",  # Routes already have /organizations/{id}/departments
