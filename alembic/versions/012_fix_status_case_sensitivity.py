"""fix status case sensitivity in fn_get_organization_users_json

Revision ID: 012_fix_status_case
Revises: 011_fix_enum_comparison
...
revision = '012_fix_status_case'
down_revision = '011_fix_enum_comparison'
branch_labels = None
depends_on = None


def upgrade() -> None:
    # Drop and recreate function with fixed case sensitivity
